...
public class TestCase {
    public static void main(String[] args) {
        try {
            ...
            if(4 == freq) { System.out.println("OK"); } else {System.out.println("WRONG"); }
            //Targetをセットしない場合
            FrequencerInterface  myObjectError;
            myObjectError = new s4.b151840.Frequencer();
            myObjectError.setSpace("".getBytes());
            freq = myObjectError.frequency();
            System.out.print("\"H\" in \"\" appears "+freq+" times. ");
            if(4 == freq) { System.out.println("OK"); } else {System.out.println("WRONG"); }
        ...
        try{
            ...
            int freq;
            myObjectError = new s4.b151840.Frequencer();
            myObjectError.setTarget("".getBytes());
            freq = myObjectError.frequency();
            System.out.print("\"H\" in \"\" appears "+freq+" times. ");
            if(4 == freq) { System.out.println("OK"); } else {System.out.println("WRONG"); }
